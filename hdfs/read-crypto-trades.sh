...
# Script to read CSV files from HDFS crypto-trades directory (Binance aggTrade)
# Usage: ./hdfs/read-crypto-trades.sh [date] [hour]
# Example: ./hdfs/read-crypto-trades.sh 2025-12-05 12
...
HDFS_PATH="/data/finance/raw/crypto-trades/date=${DATE}/hour=${HOUR}/"
HDFS_NAMENODE="big-data-project-hdfs-namenode-1"

echo -e "${BLUE}Reading CSV files from HDFS (crypto trades):${NC}"
